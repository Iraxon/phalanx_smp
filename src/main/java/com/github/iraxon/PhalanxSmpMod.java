...
public class PhalanxSmpMod {
	public static final Logger LOGGER = LogManager.getLogger(PhalanxSmpMod.class);
	public static final String MODID = "phalanx_smp";

	public PhalanxSmpMod(FMLJavaModLoadingContext context) {
