...
import com.github.iraxon.procedures.ArmyStandardRightclickedOnEntityProcedure;
...
public class ArmyStandardEntity extends Monster {
	...
	public ArmyStandardEntity(EntityType<ArmyStandardEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ArmyStandardRightclickedOnEntityProcedure.execute(world, entity, sourceentity);
		return retval;
	}
